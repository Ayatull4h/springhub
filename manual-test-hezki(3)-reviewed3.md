...
|P|Daftar laporan|Semua laporan + foto thumbnail|PASS|
...
|4.9|Kirim|Isi required + 3 foto → sukses|PASS, setelah submit foto dan pilih isi lagi foto tidak hilang|
...
|5.2|Deskripsi|"SATU FORM = SATU POHON"|FAIL, tidak ada deskripsi, |
...
|7.2|Activity marker (7)|Lingkaran abu 8px untuk tree-planting, rorak, dll — **tanpa** lingkaran 5km|FAIL, tidak ada abu-abu|
...
|#|Yang Dicek|Cara Cek|Hasil|
|-|-|-|-|
|11.1|Landing page|Semua section berubah|FAIL, pasar bibit masih tidak berhasil di dark mode|
...
|15.5|Upload foto offline|3 foto (1 per field)|FAIL, diperlukan 3 per field, total minimum 9 foto|
...
|15.10|Auto-fill WA|Login → offline → WA terisi dari cache|FAIL, tidak ada auto-fill|
...
|16.6|Kirim|Submit → sukses|FAIL, saat coba submit perlu 3 foto, walaupun sudah ada 3 foto|
|16.7|Proposal PDF|Upload opsional|PASS, tapi ga bisa di preview|
...
|18.5|Admin approve|Laporan seedling → approve → card aktif|FAIL|
|18.6|Selesai 2 langkah|Penyedia klik "Selesai" + penerima klik "Selesai" → stok berkurang|PASS|
...
|19.2f|Field 10|Jenis organisasi, nama, kontak, bentuk kolaborasi, cerita|-|
...
|26.5|Default C8|Default "Observasi Sendiri"|FAIL, tidak ada defaoult|
