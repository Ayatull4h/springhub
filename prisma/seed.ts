  ...
  const mediaItems = [
    {
      ...
      imageUrl: "https://i.ytimg.com/vi/oUDA1loE8BE/maxresdefault.jpg",
    ...
    },
    {
      section: "media",
      type: "event",
      title: "Restorasi Sumber Sabrangan, Mojokerto",
      subtitle: "30 Des 2025 · Reboisasi · Sumber Jubel",
      description: "Kegiatan kolektif membersihkan sedimen, menanam ribuan bibit bambu, dan merawat catchment Sumber Jubel di lereng Gunung Welirang.",
      imageUrl: "",
      linkUrl: "https://mojokerto.disway.id/news/read/7545/jaga-mata-air-gelar-tanam-pohon-dan-bersihkan-sumur-resapan-di-area-sumber-jubel-pacet-mojokerto",
    ...
    },
    {
      ...
      subtitle: "Jan 2026 · Kompas.id",
      description: "Liputan media tentang gerakan warga Kebumen menolak tambang dan menjaga 28 titik mata air karst.",
      imageUrl: "https://asset.kompas.id/image/2025/01/cropping-karst-gombong.jpg",
      linkUrl: "https://interaktif.kompas.id/baca/karst-gombong-selatan-bukan-sekadar-batuan-kapur/",
