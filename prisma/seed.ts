  ...
  const formDefs = [
    {
      ...
      fields: [
        ...
        { fieldId: "photo", label: "Foto Mata Air", type: "photo", required: true, helpText: "Min 3, maks 5 foto", sortOrder: 8 },
      ],
    },
    {
      ...
      fields: [
        ...
        { fieldId: "regency", label: "Kabupaten/Kota", type: "text", required: true, placeholder: "", sortOrder: 3 },
        { fieldId: "date", label: "Tanggal Kegiatan", type: "date", required: true, placeholder: "", sortOrder: 4 },
        { fieldId: "activity_types", label: "Jenis Kegiatan", type: "multiselect", required: true, options: JSON.stringify(["Pembersihan", "Pembuatan Bak Penampung", "Drainase", "Terassering", "Kombinasi"]), sortOrder: 5 },
        { fieldId: "volunteer_count", label: "Jumlah Relawan", type: "number", required: true, placeholder: "cth: 15", sortOrder: 6 },
        { fieldId: "measurement", label: "Pengukuran (meter/unit)", type: "number", required: false, placeholder: "cth: 200", sortOrder: 7 },
        ...
        { fieldId: "photo_before", label: "Foto Sebelum", type: "photo", required: false, helpText: "Min 3, maks 5 foto", sortOrder: 9 },
        { fieldId: "photo_after", label: "Foto Sesudah", type: "photo", required: true, helpText: "Min 3, maks 5 foto. Sertakan foto sesudah kegiatan", sortOrder: 10 },
        { fieldId: "coordinator_phone", label: "No. HP Koordinator", type: "phone", required: false, placeholder: "08xxx atau +62xxx", sortOrder: 11 },
      ],
    },
    {
      ...
      fields: [
        ...
        { fieldId: "regency", label: "Kabupaten/Kota", type: "text", required: true, placeholder: "", sortOrder: 3 },
        { fieldId: "date", label: "Tanggal Kegiatan", type: "date", required: true, placeholder: "", sortOrder: 4 },
        { fieldId: "trench_count", label: "Jumlah Parit (rorak)", type: "number", required: true, placeholder: "cth: 5", sortOrder: 5 },
        { fieldId: "dimensions", label: "Ukuran (pxlxt dalam cm)", type: "text", required: false, placeholder: "cth: 300x40x60", sortOrder: 6 },
        { fieldId: "location", label: "Lokasi", type: "location", required: true, sortOrder: 7 },
        { fieldId: "notes", label: "Catatan", type: "textarea", required: false, placeholder: "Lokasi parit, kondisi tanah, dll", sortOrder: 8 },
        { fieldId: "photo", label: "Foto Parit", type: "photo", required: true, helpText: "Min 3, maks 5 foto", sortOrder: 9 },
      ],
    },
    {
      ...
      fields: [
        ...
        { fieldId: "regency", label: "Kabupaten/Kota", type: "text", required: true, placeholder: "", sortOrder: 3 },
        { fieldId: "date", label: "Tanggal Kegiatan", type: "date", required: true, placeholder: "", sortOrder: 4 },
        { fieldId: "tree_count", label: "Jumlah Pohon Ditanam", type: "number", required: true, placeholder: "cth: 50", sortOrder: 5 },
        { fieldId: "tree_species", label: "Jenis Pohon", type: "text", required: false, placeholder: "cth: Bambu, Beringin, Kaliandra", sortOrder: 6 },
        { fieldId: "location", label: "Lokasi", type: "location", required: true, sortOrder: 7 },
        { fieldId: "notes", label: "Catatan", type: "textarea", required: false, placeholder: "Luas area, tingkat hidup, dll", sortOrder: 8 },
        { fieldId: "photo", label: "Foto Penanaman", type: "photo", required: true, helpText: "Min 3, maks 5 foto", sortOrder: 9 },
      ],
    },
    {
      ...
      fields: [
        ...
        { fieldId: "province", label: "Provinsi", type: "province", required: true, placeholder: "", sortOrder: 3 },
        { fieldId: "regency", label: "Kabupaten/Kota", type: "text", required: true, placeholder: "", sortOrder: 4 },
        { fieldId: "contact_name", label: "Nama Narahubung", type: "text", required: true, placeholder: "", sortOrder: 5 },
        { fieldId: "contact_phone", label: "No. HP Narahubung", type: "phone", required: true, placeholder: "08xxx atau +62xxx", sortOrder: 6 },
        { fieldId: "location", label: "Lokasi", type: "location", required: true, sortOrder: 7 },
        { fieldId: "date", label: "Tanggal Update Stok", type: "date", required: true, placeholder: "", sortOrder: 8 },
        { fieldId: "notes", label: "Catatan", type: "textarea", required: false, placeholder: "Sumber bibit, kebutuhan ke depan", sortOrder: 9 },
        { fieldId: "photo", label: "Foto Bibit", type: "photo", required: true, helpText: "Min 3, maks 5 foto", sortOrder: 10 },
      ],
    },
  ];
