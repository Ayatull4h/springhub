  ...
  const formDefs = [
    {
      ...
      fields: [
        ...
        { fieldId: "D1_ph", label: "pH Air", type: "number", required: false, sortOrder: 24 },
        { fieldId: "D2_suhu", label: "Suhu Air (°C)", type: "number", required: false, sortOrder: 25 },
        { fieldId: "D3_tds", label: "TDS (ppm)", type: "number", required: false, sortOrder: 26 },
        { fieldId: "D4_ec", label: "EC/DHL (µS/cm)", type: "number", required: false, sortOrder: 27 },
        { fieldId: "D5_debit_liter", label: "Debit Air (liter/detik)", type: "number", required: false, sortOrder: 28 },
