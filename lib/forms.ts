...
export const FORMS: FormSchema[] = [
  {
    ...
    fields: [
      ...
      { id: "B7_debit_5th", label: "Perbandingan Debit 5 Tahun Lalu", type: "select", required: true, options: ["Bertambah", "Sama", "Berkurang", "Tidak Tahu"] },
...
export const springMonitoringSchema = z.object({
  ...
  B7_debit_5th: z.string().min(1, "Perbandingan debit wajib diisi").max(500),
...
export const springRestorationSchema = z.object({
  A_tanggal: z.string().min(1, "Tanggal kegiatan wajib diisi").max(500),
  A_nama: z.string().min(1, "Nama koordinator wajib diisi").max(500),
  A_wa: z.string().min(1, "Nomor WA wajib diisi").max(500),
  A_organisasi: z.string().max(500).optional(),
  A_geotag_lat: z.string().max(500).optional(),
  A_geotag_lng: z.string().max(500).optional(),
  S1_spring: z.string().min(1, "Nama mata air wajib diisi").max(500),
  S2_kondisi: z.string().min(1, "Kondisi sebelum restorasi wajib diisi").max(500),
  ...
  S6_durasi: z.string().min(1, "Durasi kegiatan wajib diisi").max(500),
});

export const trenchDevelopmentSchema = z.object({
  A_tanggal: z.string().min(1, "Tanggal kegiatan wajib diisi").max(500),
  A_nama: z.string().min(1, "Nama pelapor wajib diisi").max(500),
  A_wa: z.string().min(1, "Nomor WA wajib diisi").max(500),
  A_kegiatan: z.string().max(500).optional(),
  A_geotag_lat: z.string().max(500).optional(),
  A_geotag_lng: z.string().max(500).optional(),
  A_akurasi_gps: z.coerce.number().min(1, "Akurasi GPS wajib diisi"),
  A_kode_event: z.string().max(500).optional(),
  A_kode_spring: z.string().max(500).optional(),
  R1_jenis: z.string().min(1, "Jenis struktur wajib diisi").max(500),
  R2_bentuk: z.string().min(1, "Bentuk penampang wajib diisi").max(500),
  R3_diameter: z.string().max(500).optional(),
  R3_kedalaman_silinder: z.string().max(500).optional(),
  R3_panjang: z.string().max(500).optional(),
  R3_lebar: z.string().max(500).optional(),
  R3_kedalaman_kotak: z.string().max(500).optional(),
  R4_foto: z.any().optional(),
  R5_posisi: z.string().min(1, "Posisi rorak wajib diisi").max(500),
  R6_bahan: z.string().max(500).optional(),
});
...
export const treePlantingSchema = z.object({
  ...
  A_kode_event: z.string().max(500).optional(),
  A_kode_spring: z.string().max(500).optional(),
  T_nama_lokal: z.string().min(1, "Nama lokal pohon wajib diisi").max(500),
  T_nama_ilmiah: z.string().max(500).optional(),
  T_foto: z.any().optional(),
  T_tinggi: z.string().min(1, "Tinggi bibit wajib diisi").max(500),
  T_sumber: z.string().min(1, "Sumber bibit wajib diisi").max(500),
  T_lokasi_tanam: z.string().min(1, "Lokasi tanam wajib diisi").max(500),
  T_tag: z.string().max(500).optional(),
  T_catatan: z.string().max(5000).optional(),
});

export const seedlingStockSchema = z.object({
  A_tanggal: z.string().min(1, "Tanggal wajib diisi").max(500),
  A_nama: z.string().min(1, "Nama narahubung wajib diisi").max(500),
  A_wa: z.string().min(1, "Nomor WA wajib diisi").max(500),
  A_organisasi: z.string().max(500).optional(),
  A_geotag_lat: z.string().max(500).optional(),
  A_geotag_lng: z.string().max(500).optional(),
  A_entri_baru: z.string().min(1, "Entri baru/pembaruan wajib diisi").max(500),
  A_kode_stok: z.string().max(500).optional(),
  B1_jenis_laporan: z.string().min(1, "Jenis laporan wajib diisi").max(500),
  B2_nama_lokal: z.string().min(1, "Nama tanaman wajib diisi").max(500),
  B2_nama_ilmiah: z.string().max(500).optional(),
  B3_jumlah: z.coerce.number().min(1, "Jumlah bibit wajib diisi"),
  B3_akurasi: z.string().max(500).optional(),
  C1_foto: z.any().optional(),
  C2_tinggi: z.string().max(500).optional(),
  C3_bentuk: z.string().max(500).optional(),
  C4_kesiapan: z.string().max(500).optional(),
});
