    ...
    <div className="container-page py-16 dark:text-slate-300">
      ...
      <div className="mt-8 space-y-6">
        <section className="rounded-xl border border-line bg-white dark:border-slate-700 dark:bg-slate-900 p-6">
          <h2 className="text-xl font-semibold text-ink dark:text-white">Data yang Dikumpulkan</h2>
        ...
        <section className="rounded-xl border border-line bg-white dark:border-slate-700 dark:bg-slate-900 p-6">
          <h2 className="text-xl font-semibold text-ink dark:text-white">Bagaimana Data Digunakan</h2>
          <p className="mt-2 text-ink-muted dark:text-slate-400">
        ...
        <section className="rounded-xl border border-line bg-white dark:border-slate-700 dark:bg-slate-900 p-6">
          <h2 className="text-xl font-semibold text-ink dark:text-white">Privasi Lokasi</h2>
          <p className="mt-2 text-ink-muted dark:text-slate-400">
        ...
        <section className="rounded-xl border border-line bg-white dark:border-slate-700 dark:bg-slate-900 p-6">
          <h2 className="text-xl font-semibold text-ink dark:text-white">Hak Pengguna</h2>
          <p className="mt-2 text-ink-muted dark:text-slate-400">
            Anda dapat meminta akses, koreksi, atau penghapusan data Anda kapan saja. Hubungi
            kami melalui email untuk melaksanakan hak Anda.
          </p>
        </section>
        <section className="rounded-xl border border-line bg-white dark:border-slate-700 dark:bg-slate-900 p-6">
          <h2 className="text-xl font-semibold text-ink dark:text-white">Kontak</h2>
          <p className="mt-2 text-ink-muted dark:text-slate-400">
