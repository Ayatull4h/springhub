  ...
  return (
    <div className="container-page py-16">
      ...
      <div className="mt-8 space-y-6">
        <section>
          <h2 className="text-xl font-semibold text-ink">Cara Melaporkan</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-ink">Cara Mendapatkan Poin</h2>
          <p className="mt-2 text-ink-muted">
        ...
        <section>
          <h2 className="text-xl font-semibold text-ink">Cara Bergabung</h2>
          <p className="mt-2 text-ink-muted">
