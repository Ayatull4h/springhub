...
|2|Both|Isi Nama mata air, Desa, Kecamatan, Provinsi, Kota/Kab, Tanggal|Semua input terisi|✅|Box tanggal masih terpotong dikit pada HP|
...
|7|PC|Klik "🖱️ Pick from Map"|Map picker terbuka, klik map → koordinat terisi|✅|Saat map muncul header dari website tertutup oleh map|
|8|Both|Isi Catatan pengamatan (opsional)|Text terisi|✅||
|9|Both|Klik **Submit Report**|Loading muncul, lalu halaman success ✅|❌|Saat ingin submit terdpat teks bahwa foto tidak bisa terupload, tapi tetap tersimpan|
...
|7|Both|Klik **Checkout / Donate Now**|Redirect ke halaman Xendit invoice|❌|XENDIT\_SECRET\_KEY is not set. Cannot create invoice.|
...
|4|HP|Step 3: Pilih radius 3km + kualitas "Ringan" → Next|Konfigurasi tersimpan|✅❌|Pertama kali bisa, tapi pas coba lagi terdapat error message, walaupun sudah mendelet cache|
...
|7|HP|Step 6: Klik **Mulai Survey**|Map offline terbuka, GPS overlay muncul|❌|GPS map tidak muncul|
...
|16|HP|Ambil foto dari **galeri**|Galeri terbuka, foto tersimpan|❌|Tidak ada opsi galeri|
...
|20|HP|Klik **🗺️ Track + Map**|Download file .png: screenshot map + overlay info|❌|Saat mencoba open filenya, bentuk txt dan  sama seperti file Track saja|
...
|4|Both|Cek halaman **Report Issue**|Form, textarea, button gelap|❌|Text area terang|
...
|2|Both|Cek Landing: "Map", "Dashboard", "Community", "Learn", "Media", "Donate"|Nav berubah Inggris|❌|Pada Dashboard, Spring, Donasi, Activities  ada yang tidak terganti menjadi Inggris.<br />Konten dan Judul module campur antara Inggris dan Indo|
|3|Both|Cek About: "About SpringHub", "Vision \& Mission"|Konten berubah|✅||
|4|Both|Cek Form: field labels English|Berubah|❌|PAda form semua opsi masih dalam bentuk Bahasa Indonesia|
...
|2|Both|Uncentang "Monitoring"|Marker + list item monitoring hilang|-|Tidak ada opsi monitoring, jika maksudnya opsi Springs maka berarti berhasil.|
|3|Both|Uncentang "Tree Planting"|Marker + list item tree hilang|✅||
|4|Both|Centang kembali|Marker + list item muncul lagi|✅|Pada peta warna titik pada opsi Show, dan pada peta ada yang berbeda warna seperti springs (warna hijau di show) tapi warna biru tua pada peta. Serta Restoration yang warna kuning pada show tapi warna biru muda di peta<br />|
...
|#|Device|Aksi|Harapan|✅/❌|Catatan|
|-|-|-|-|-|-|
|1|Both|Buka `/about`|Hero: "Tentang SpringHub", paragraf deskripsi|✅|Tidak ada Bahasa Inggrisnya|
|2|Both|Scroll ke Visi \& Misi|Paragraf visi terbaca|✅|Tidak ada Bahasa Inggrisnya|
|3|Both|Cek grid 6 value cards|Masing-masing icon (Droplets, Users, TreePine, Shield, Heart, MapPin) + judul + desc|✅|Tidak ada Bahasa Inggrisnya|
|4|Both|Scroll ke CTA|Tombol "Gabung Sekarang" → `/join`|✅|Tidak ada Bahasa Inggrisnya|
|5|Both|Klik "Lihat Peta"|Scroll ke section map di landing|✅|Tidak ada Bahasa Inggrisnya|
...
|9|Both|Footer: klik icon **Facebook**|Buka FB @jagasemesta (tab baru)|❌|Facebooknya Jagasemesta yang salah|
...
|#|Device|Aksi|Harapan|✅/❌|Catatan|
|-|-|-|-|-|-|
|1|Both|Cari floating button ⭐ di kanan bawah halaman|Tombol muncul, selalu visible walau di-scroll|-|Tidak tertemu floating button|
