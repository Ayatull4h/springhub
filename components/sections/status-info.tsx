  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1 text-xs text-ink-muted hover:text-ink transition underline underline-offset-2"
          ...
          >
            ...
            <div className="mt-4 space-y-4">
              <div className="flex items-start gap-3">
                <Circle className="mt-0.5 h-5 w-5 shrink-0 fill-blue-500 text-blue-500" />
                <div>
              ...
              <div className="flex items-start gap-3">
                <Circle className="mt-0.5 h-5 w-5 shrink-0 fill-amber-500 text-amber-500" />
                <div>
