    ...
    <section id="community" className="relative overflow-hidden bg-[#f6f1fb] pt-16 md:pt-20 dark:bg-slate-900/60">
      ...
      <div className="mt-10 grid gap-4 lg:grid-cols-12">
        <div className="flex flex-col lg:col-span-7">
          ...
          <BkkCloudBox className="bg-white p-6 pb-8 dark:bg-slate-900 drop-shadow-[0_18px_28px_rgba(61,22,96,0.16)]" flip={false} tall>
        ...
        <BkkCloudBox className="bg-gradient-to-br from-tang-100 to-cream p-6 pb-8 h-full dark:from-slate-800 dark:to-slate-900 drop-shadow-[0_18px_28px_rgba(61,22,96,0.16)]" flip tall>
